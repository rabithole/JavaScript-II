...
// 	allCaps.push(value.first_name.toUpperCase());
// })
...
/* 		Solution 3	 	*/
// const caps = runners.map(value => value.first_name.toUpperCase());
// console.log(caps);
...
/* 	Solution 1 	*/
// largeShirts.push(runners.filter(first_name => first_name.shirt_size === 'L'));
// console.log(largeShirts);

/* 	Solution 2 	*/
// const lgShirts = runners.filter(function(first_name){
// 	return first_name.shirt_size === 'L';
// })
// console.log(lgShirts);
...
runners.forEach(function(value){
	totalDonations.push(value.donation);
})
// console.log(totalDonations);

ticketPriceTotal.push(totalDonations.reduce(function(acc, curr){
	return acc + curr;
}))
